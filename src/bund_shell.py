...
from bund_interactive import BUND_INTERACTIVE

class BUND_SHELL(BUND_TERMINAL, BUND_GEN, BUND_HELP,
                 BUND_ENV, BUND_ARGS, BUND_INTERACTIVE):
    def __init__(self):
        self.doc = []
        ...
        BUND_INTERACTIVE.__init__(self)
